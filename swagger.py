...
class Historical(Resource):
	def get(self):
		csvfile = open('/home/ubuntu/Weather/dailyweather.csv', 'r')
	...
	def post(self):
		...
		csvfile = open('/home/ubuntu/Weather/dailyweather.csv', 'r')
		outputfile = open('/home/ubuntu/Weather/output.csv','w',newline='')	
		fieldnames = ("DATE","TMAX","TMIN")
		...
		outputfile.close()
		csvfile.close()
		#os.remove('/home/ubuntu/Weather/dailyweather.csv')
		os.rename('/home/ubuntu/Weather/output.csv','/home/ubuntu/Weather/dailyweather.csv')
		if exists == 0:
			csvfile = open('/home/ubuntu/Weather/dailyweather.csv', 'r')
			fieldnames = ("DATE","TMAX","TMIN")
			final_list = []
			reader = csv.DictReader( csvfile, fieldnames)
			header = next(reader)
			csvfile2 = open('/home/ubuntu/Weather/dailyweather.csv', 'r')
			...
			with open('/home/ubuntu/Weather/dailyweather.csv','w',newline='') as add_file:
				print('file opened')
		...
		if exists == 1:
			if count < 7:
				...
				for i in range(0,7-appended_row_count):
					icsvfile = open('/home/ubuntu/Weather/dailyweather.csv', 'r')
